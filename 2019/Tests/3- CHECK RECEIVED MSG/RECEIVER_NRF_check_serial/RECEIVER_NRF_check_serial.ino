///////VERSION RECEIVER PARA SELECCIONAR ENTRE MIDI USB NATIVO Y VIRTUAL MIDI PORT 
///////IR CON Ctrl+F BUSCANDO "SELECCIONAR MIDI"
...
/////CONFIG MIDI SELECCIONAR SEGUN CORRESPONDA
...
void setup() {
  ...
  /////Seleccionar en caso de MIDI Virtual
  //MIDI.begin(1);
  //////
  ...
  */
   ...
   ////SIGUE EL PEDAZO DE CODIGO DEL DEBUG DE MENSAJE RECIBIDO/////////////////
   /////EN CASO DE QUERER CHEQUEAR MENSAJE RECIBIDO DESDE CAXIXIS/////////////////
  /*
  Serial.begin(9600);
  delay(100);
  radio.begin();
...
///////TODO LO QUE SIGUE ES PARA CHEQUEAR Y FUE SACADO DE UNA VERSION DE RECEIVER MIDI NATIVO DE LOS ULTIMOS QUE SUPUESTAMENTE FUNCIONAR EN BSAS
...
/*
/////ESTE ES EL PLAY BUFFER ORIGINAL QUE AL MENOS FUNCIONA EN VIRTUAL MIDI
void PlayBuffer() {
  if(play){
    if(samples[bufferJ].time-time<0 && samples[bufferJ].time-time>-100){//Esto es un hardcodeo (el -100), corregirlo mirando el reloj en la V2, o dejarlo...
      if(samples[bufferJ].encendido){
